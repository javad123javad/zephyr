...
typedef void (*llcc68_api_evt_handler)(const struct device *dev, uint16_t events);
 ...
 */
typedef int (*llcc68_api_set_state)(const struct device *dev, enum llcc68_state state);
 ...
 * @return 0 on success, negative errno code on failure
 */
typedef int (*llcc68_api_set_frequency)(const struct device *dev, uint32_t frequency);
 ...
 * @return 0 on success, negative errno code on failure
 */
typedef int (*llcc68_api_set_lora_config)(const struct device *dev, 
 ...
 * @return 0 on success, negative errno code on failure
 */
typedef int (*llcc68_api_send)(const struct device *dev, uint8_t *data, uint32_t len);
 ...
 * @return 0 on success, negative errno code on failure
 */
typedef int (*llcc68_api_receive)(const struct device *dev, uint8_t *data, uint8_t *len);
 ...
 * @return 0 on success, negative errno code on failure
 */
typedef int (*llcc68_api_set_rx)(const struct device *dev, uint32_t timeout_ms);
 ...
 * @return 0 on success, negative errno code on failure
 */
typedef int (*llcc68_api_set_cad)(const struct device *dev);
 ...
 * @return 0 on success, negative errno code on failure
 */
typedef int (*llcc68_api_set_event_handler)(const struct device *dev, llcc68_api_evt_handler handler);
 ...
 * @return 0 on success, negative errno code on failure
 */
typedef int (*llcc68_api_get_rssi)(const struct device *dev, int16_t *rssi);
 ...
 * @return 0 on success, negative errno code on failure
 */
typedef int (*llcc68_api_get_snr)(const struct device *dev, int8_t *snr);

__subsystem struct llcc68_lora_api {

	llcc68_api_set_state set_state; 
        llcc68_api_set_frequency set_frequency;
        llcc68_api_set_lora_config set_lora_config;
        llcc68_api_send send;
        llcc68_api_receive receive;
        llcc68_api_set_rx set_rx;
        llcc68_api_set_cad set_cad;
        llcc68_api_set_event_handler set_event_handler; 
        llcc68_api_get_rssi get_rssi;
	llcc68_api_get_snr get_snr;
