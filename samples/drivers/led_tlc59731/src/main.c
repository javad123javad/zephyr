...
#define NUM_COLORS 3    /* NUBER OF LEDs in a RGB LED */
...
{
	/* Blink */
	led_blink(tlc59731, RED, TEST_DELAY, TEST_DELAY);
	led_blink(tlc59731, GREEN, TEST_DELAY, TEST_DELAY);
	led_blink(tlc59731, BLUE, TEST_DELAY, TEST_DELAY);
}
