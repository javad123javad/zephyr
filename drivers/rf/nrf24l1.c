...
static uint8_t nrf24l01_set_register_bit(const struct device *dev, uint8_t reg, uint8_t bit, bool val)
{
...
static uint8_t nrf24l01_write_register_len(const struct device *dev, uint8_t reg, const uint8_t* data, uint8_t len)
{
    const struct nrf24l01_config *config = dev->config;
...
static uint8_t nrf24l01_write_payload_core(const struct device *dev, const void* buf, uint8_t data_len, const uint8_t write_type)
{
    int ret;
    /* Can be TX or RX ACK*/
    struct nrf24l01_data *data = dev->data;
...
static inline void nrf24l01_toggle_reading_pipe(const struct device *dev, uint8_t rx_pipe, bool activate)
{
...
//////////////////////////
int nrf24l01_config(const struct device *dev,
